...
if(isset($_POST['submit'])){
    ...
    if($run_sql){
        ...
        <script>
            alert('Berjaya');
            window.location.replace("http://localhost/psm_v1/role_tambah.php");
        </script>
<?php    
}
else{
            ...
            <form role="form" action="" method="post">
              <div class="box-body">
                <div class="form-group">
                  <label for="exampleInputEmail1">Nama Peranan </label>
                  <input type="text" class="form-control" id="exampleInputEmail1" name="role_name" placeholder="Cth peranan : Pentadbir">
                </div>
